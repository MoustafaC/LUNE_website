 ...
 */
function lune_nu_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter LU/NE nü default saturation level.
	 *
	 * @since LU/NE nü 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'lune_nu_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.lune_nu-front-page) .entry-title,
...
.colors-custom .lune_nu-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.lune_nu-front-page .panel-content .recent-posts article,
...
.colors-custom.lune_nu-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters LU/NE nü custom colors CSS.
	 *
	 * @since LU/NE nü 1.0
	 *
	 ...
	 */
	return apply_filters( 'lune_nu_custom_colors_css', $css, $hue, $saturation );
}
